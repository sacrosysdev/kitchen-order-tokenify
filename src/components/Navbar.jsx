  ...
  return (
    <div className='text-black bg-[#F1F1F1]  flex items-center justify-between py-2 px-5'>
        ...
        <div className='flex items-center gap-5'>
            ...
            <button className='flex items-center cursor-pointer bg-[#DC2626] hover:bg-red-700 p-2 gap-1 rounded-md text-[#F1F1F1] transition-colors duration-100 ease-in-out'>
                <img src={Exit} alt="usericon" className='h-4 w-4 object-contain'/>
